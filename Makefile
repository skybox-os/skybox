x86:
	...
	ld -m elf_i386 -T ./src/arch/x86/linker.ld ./tmp/bin/6699abaa.o ./tmp/bin/abababab.o ./tmp/bin/66ababaa.o ./tmp/bin/669babaa.o ./tmp/bin/669aaa5a.o ./tmp/bin/669aaa5d.o ./tmp/bin/6adaaa5d.o ./tmp/bin/6b9n4a5d.o ./tmp/bin/669n4a5d.o ./tmp/bin/6b9daa5d.o ./tmp/bin/6b9d4a5d.o ./tmp/bin/2b25edc6.o ./tmp/bin/6b9d415d.o -o ./bin/skybox.bin -nostdlib
